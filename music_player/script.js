...
const songs = [
    {
        ...
        path: "../music_player/beats/Aankhon Mein Teri Ajab Si (Lyrical) Om Shanti Om _ K.K. _ Shahrukh Khan _ Deepika Padukone (128 kbps).mp3",
        singer: "Krishnakumar Kunnath",
        thumbnailPath: "../music_player/trackImg/ankho me teri.gif",
        special:"0"
    },
    {
        title: "Sajni",
        path: "../music_player/beats/Sajni .MP3",
        singer: "Arijit Singh",
        thumbnailPath: "../music_player/trackImg/sajni.jpg",
        special:"0"
    },
    {
        title: "295",
        path: "../music_player/beats/295 (Official Audio) _ Sidhu Moose Wala _ The Kidd _ Moosetape (256 kbps).mp3",
        singer: "Sidhu Moose Wala",
        thumbnailPath: "../music_player/trackImg/295.jpg",
        special:"0"
    },
    {
        title: "One Call",
        path: "../music_player/beats/Rich Amiri - One Call (Official Audio) (320 kbps).mp3",
        singer: "Rich Amiri",
        thumbnailPath: "../music_player/trackImg/one calll.jpeg",
        special:"0"
    }
    // ,
    // {
